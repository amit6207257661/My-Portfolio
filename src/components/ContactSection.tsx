  ...
  const contactInfo = [
    {
      icon: MailIcon,
      title: "Email",
      value: "rudhrapratapsingh.5.rs@gmail.com",
      href: "mailto:rudhrapratapsingh.5.rs@gmail.com"
    },
    {
      icon: PhoneIcon,
      title: "Phone",
      value: "+91-7267897344",
      href: "tel:+917267897344"
    },
    {
      icon: MapPinIcon,
      title: "Location",
      ...
      <div className="container px-4 mx-auto relative z-20">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Have a web development project in mind or interested in my skills? I'd love to hear from you!
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="message"
                      name="message"
                      placeholder="Tell me about your data analysis needs, questions, or just say hello!"
